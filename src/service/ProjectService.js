...
class ProjectService {
  ...
  async show(projectId, users_id) {
    const projectFound = await projectModel.findByPk(projectId, {
      where: { users_id },
    });
    ...
    const naverProjectFound = await naverProjectModel.findAll({
      where: { projects_id: projectFound.id },
    });
  ...
  async update(project, users_id) {
    ...
    const projectFound = await projectModel.findByPk(id, {
      where: { users_id },
    });
